                ...
                <g transform="translate(0, 0)">
                    ...
                    <g transform="translate(0, 75)">
                        ${
                            hideIcons
                                ? ""
                                : `<path fill-rule="evenodd" fill="${icon}" d="M8.75 1.75a.75.75 0 00-1.5 0V5H4a.75.75 0 000 1.5h3.25v3.25a.75.75 0 001.5 0V6.5H12A.75.75 0 0012 5H8.75V1.75zM4 13a.75.75 0 000 1.5h8a.75.75 0 100-1.5H4z" />`
                        }
                    ...
                    <g transform="translate(0, 100)">
                        ...
                        <text x="25" y="12.5" font-size="12px" fill="${text}">Repositories with contributions</text>
