...
export default class StatsCard extends BaseCard {
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="360" height="185" viewBox="0 0 360 185" font-family="${
        design.ftext.family
    }" font-size="${design.ftext.size}" font-weight="${design.ftext.weight}">
        <rect x="5" y="5" width="350" height="175" fill="${
            design.fdesign.background
        }" stroke="${
            design.fdesign.border
  ...
  <image x="5" y="5" clip-path="url(#background)" preserveAspectRatio="xMidYMid slice" href="data:image/png;base64,${base64}" width="390" height="175" />`
        ...
        <text fill="${design.fdesign.title}" font-weight="${
            design.ftext.title.weight
        }" font-size="${
            ...
            design.fdesign.text
                ...
                <g transform="translate(0, 25)">
                    ${
                        hide_icons
                            ? ""
                            : `<path fill-rule="evenodd" fill="${design.fdesign.icon}" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z" />`
                    }
                    <text x="25" y="12.5" font-size="${
                        design.ftext.text.size
                    }" font-weight="${design.ftext.text.weight}" fill="${
            ...
            design.fdesign.text
                ...
                <g transform="translate(0, 50)">
                    ${
                        hide_icons
                            ? ""
                            : `<path fill-rule="evenodd" fill="${design.fdesign.icon}" d="M8 9.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path><path fill-rule="evenodd" fill="${design.fdesign.icon}" d="M8 0a8 8 0 100 16A8 8 0 008 0zM1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z"></path>`
                    }
                    <text x="25" y="12.5" font-size="${
                        design.ftext.text.size
                    }" font-weight="${design.ftext.text.weight}" fill="${
            ...
            design.fdesign.text
                ...
                <g transform="translate(0, 75)">
                    ${
                        hide_icons
                            ? ""
                            : `<path fill-rule="evenodd" fill="${design.fdesign.icon}" d="M1.643 3.143L.427 1.927A.25.25 0 000 2.104V5.75c0 .138.112.25.25.25h3.646a.25.25 0 00.177-.427L2.715 4.215a6.5 6.5 0 11-1.18 4.458.75.75 0 10-1.493.154 8.001 8.001 0 101.6-5.684zM7.75 4a.75.75 0 01.75.75v2.992l2.028.812a.75.75 0 01-.557 1.392l-2.5-1A.75.75 0 017 8.25v-3.5A.75.75 0 017.75 4z"></path>`
                    }
                    <text x="25" y="12.5" font-size="${
                        design.ftext.text.size
                    }" font-weight="${design.ftext.text.weight}" fill="${
            ...
            design.fdesign.text
                ...
                <g transform="translate(0, 100)">
                    ${
                        hide_icons
                            ? ""
                            : `<path fill-rule="evenodd" fill="${design.fdesign.icon}" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z" />`
                    }      
                    <text x="25" y="12.5" font-size="${
                        design.ftext.text.size
                    }" font-weight="${design.ftext.text.weight}" fill="${
