...
export default class StatsCard extends BaseCard {
  ...
  protected async fetch(): Promise<UserFetcherResponse> {
    ...
    return {
      ...
      contributions: data.user.repositoriesContributedTo.totalCount.toString(),
    };
  }
            ...
            <g transform="translate(0, 0)">
                ...
                <g transform="translate(0, 50)">
                    ${
                      hide_icons
                        ? ""
                        : `<path fill-rule="evenodd" fill="${design.icon}" d="M8 9.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path><path fill-rule="evenodd" fill="${design.icon}" d="M8 0a8 8 0 100 16A8 8 0 008 0zM1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z"></path>`
                    }
                    <text x="25" y="12.5" font-size="12px" fill="${
                      design.text
                    }">Issues</text>
